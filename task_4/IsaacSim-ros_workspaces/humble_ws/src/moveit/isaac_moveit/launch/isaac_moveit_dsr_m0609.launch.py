...
# MoveIt2 launch file for Doosan m0609 + Isaac Sim
#
# Prerequisites:
#   1. Build and source the doosan_ros2 workspace so that dsr_moveit_config_m0609
#      and dsr_description2 packages are available in the ament index.
#   2. Source this (Isaac Sim ROS) workspace on top of it.
#
# Usage (Isaac Sim 연동):
#   ros2 launch isaac_moveit isaac_moveit_dsr_m0609.launch.py
#
...
def generate_launch_description():
    ...
    # --------------------------------------------------------------------------
    # MoveIt configuration (dsr_moveit_config_m0609 as the base package)
    # --------------------------------------------------------------------------
    isaac_moveit_share = get_package_share_directory("isaac_moveit")
    custom_urdf_xacro = os.path.join(
        isaac_moveit_share, "config", "dsr_m0609_isaac.urdf.xacro"
    )
